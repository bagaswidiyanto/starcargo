...
class Galeri extends MY_Controller {
  ...
  public function index() {
	...
	// $config['base_url'] = 'https://starcargo.digitalindo.co.id/website/galeri/';
    ...
    $this->middle = 'content/v_galeri.php'; // untuk loading page homenya. rubah pada bagian ini untuk halaman lainnya.
