...
<section class="parallax parallax2 parallax-1">
  <!-- <div class="opac"> -->
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm-6 col-md-4 col-lg-3 wow fadeInLeft" data-wow-offset="200">
        ...
        <div class="widget_content">
          <img src="<?= base_url(); ?>assets/images/footerstarcargo.png" style="    margin-top: -57px; width: 200px; height: 236px; border-radius: 10px 0 0 0 ;">
        </div>
      </div>
      <div class="col-sm-6 col-md-4 col-lg-4 wow fadeInLeft" data-wow-offset="200">
        ...
        <div class="widget_content">
          ...
          <p class="foot"><?= $website->phone; ?>, <?= $i; ?></p>
          <p class="foot"><?= $website->email; ?></p>
          <!-- <ul class="contact-details-alt">
            <li><i class="fa fa-map-marker"></i>
              <p><strong>Alamat</strong>: <br><?= $website->address1; ?><br><?= $website->address2; ?><br><?= $website->address3; ?><br><?= $website->city . ', ' . $website->zipcode; ?></p>
            </li>
            <li><i class="fa fa-user"></i>
              <p><strong>Telepon/Fax</strong>: <?= $website->phone; ?>/<?= $website->fax; ?></p>
            </li>
            <li><i class="fa fa-envelope"></i>
              <p><strong>Email</strong>: <a href="#"><?= $website->email; ?></a></p>
            </li>
          </ul> -->
        </div>
      </div>
      <div class="col-sm-6 col-md-4 col-lg-2 wow fadeInDown" data-wow-offset="200">
        ...
        <div class="widget_content">
          ...
          <ul class="links">
            <li> <a href="<?= base_url('pages/index/tentang-kami'); ?>">Perusahaan</a></li>
            <li> <a href="<?= base_url('layanan'); ?>">Produk & Layanan</a></li>
            <li> <a href="<?= base_url('destination'); ?>">Destinasi</a></li>
          </ul>
...
<div class="whatsapp-chat-section">
  ...
  <div id="whatsapp-chat-popup" class="animated bounceOutDown" style="z-index: 999999; display: none;">
    ...
    <div id="list-chat-section" class="list-chat-section animated fadeIn" style="display: block;">
      ...
      <div class="header-section" style="background:#FB5C02;">
