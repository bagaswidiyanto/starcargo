    ...
    <div class="col-md-12 wow fadeInLeft" style="padding-right: 0px; padding-left: 0px">
        <div class="widget widget_tab" style="box-shadow: 0px 4px 40px rgb(0 0 0 / 30%);">
            <ul class="nav nav-tabs">
                ...
                <li class="nav-tabs active tuch" style="height: 259px;  background: linear-gradient(293.8deg, #033498 0%, #00C0FF 170.7%); box-shadow: 0px 4px 15px rgb(0 0 0 / 70%);">
                ...
                <li class="tuchhh">
                    ...
                    <div class="tab-pane fade in" id="Recent">
                        <div class="tab-pane fade active in " id="Popular">
                            <form id="contactForm" method="post" action="<?php echo base_url() . 'lokasi'; ?>">
                                <div class="col-lg-12 ">
                                    <div class="row" style="width: 416px;">
                                        <div class="form-group inputtabs">
                                            <div class="col-lg-12 ">
                        ...
                        <li class="slide<?= $slider->id ?>">
                            <div class="container">
                                <div class="flex_caption1">
                                    ...
                                    <p class="slide-heading FromTop" style="color: #FB5C02;"><?= $slider->captionSlider1; ?></p><br />
                                    <div class="lineslider">

                                    </div>

                                    <p class="sub-line FromBottom" style="color: #FB5C02;"><?= $slider->captionSlider2; ?></p><br />
            ...
            <div class="row ">
                ...
                <div class="col-sm-6 wow fadeInRight">
                    ...
                    <?php foreach ($blog as $news) { ?>
                        ...
                        <a href="<?= base_url(); ?>berita/baca/<?= $news->slug; ?>"><b><?= $news->Title; ?></b></a>
                        </p>
                ...
                <div class="col-sm-5 wow fadeInLeft">
                    <div class="dividerHeading even">
                        ...
                        <a href="<?= base_url(); ?>berita/baca/<?= $post1->slug; ?>"><strong><?= $post1->Title; ?></strong></a>
                    </div>
