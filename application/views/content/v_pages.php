...
<div class="slider_block">
	<div class="flexslider top_slider">
		<div class="col-md-12">
			<div class="row">
				<ul class="slides">
					<li class="slide" style="background-image: url('<?= base_url(); ?>assets/images/slider/perusahaan.jpg');">
...
<!-- <section class="parallax parallax-1" style="background-image: url('<?= base_url(); ?>assets/images/slider/tentang_perusahaan.jpg'); ">
<div class="container">
<div class="row">
<div class="col-lg-12 col-sm-12 wow bounceIn ">
						...
						<div class="container">
							<div class="row ">
								...
								<div class="col-lg-6 col-md-6 col-sm-6 wow fadeInDown">
									...
									<div class="col-lg-1 col-md-1 col-sm-1 wow fadeInDown">
									</div>


									<div class="col-lg-7 col-md-7 col-sm-7 wow fadeInDown">
