					...
					<div class="who">
						<div class="col-lg-12 col-md-12 col-sm-12">
							<div class="dividerHeading">
								<h4><a href="index.php">Home</a> | <span>Destinasi </span></h4>
							</div>
            ...
            <div class="row sub_content mintop60">
                <div class="col-lg-8 wow fadeInLeft">
                        <div class="panel-group accordion" id="accordion">
                        	<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet deleniti ducimus fuga quidem quisquam ut. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet deleniti ducimus fuga quidem quisquam ut. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet deleniti ducimus fuga quidem quisquam ut. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet deleniti ducimus fuga quidem quisquam ut. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet deleniti ducimus fuga quidem quisquam ut. </p>
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
                                        <i class="switch fa fa-plus"></i>Solo
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseFive">
                                        <i class="switch fa fa-plus"></i>Kalimantan</a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseSix">
                                        <i class="switch fa fa-plus"></i>Sulawesi</a>
                                </h4>
                            </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 wow fadeInRight">
                    <div class="sidebar">
                        <div class="widget_info">
                            <div class="dividerHeading">
                                <h4><span>Cek Tarif</span></h4>
                            </div>
                            <p>Masukan kota asal dan tujuan anda</p>
						...
						<div class="widget_info">
                            <div class="dividerHeading">
                                <h4><span>Status Kiriman</span></h4>
                            </div>
